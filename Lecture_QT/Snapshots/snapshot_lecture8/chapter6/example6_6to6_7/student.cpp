...
QString Student::toString() const {
  ...
  os << "[" << getClassName() << "]" //NOTE this is about dynamic binding - resolved at runtime
  //os << "[" << Student::getClassName() << "]" //NOTE this enforce static binding - resolved at compile time
     << " name: " << m_Name
     << "; Id: " << m_StudentId
     << "; Year: " << yearStr()
     << "; Major: " << m_Major;
