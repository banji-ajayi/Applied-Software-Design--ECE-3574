...
#include "../example9_2to9_3/dialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_InputForm_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 18, 11) // "chooseColor"

    },
    "InputForm\0accept\0\0chooseColor"
};
...
void InputForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        InputForm *_t = static_cast<InputForm *>(_o);
        switch (_id) {
...
const QMetaObject InputForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InputForm.data,
      qt_meta_data_InputForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InputForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InputForm.stringdata))
        return static_cast<void*>(const_cast< InputForm*>(this));
