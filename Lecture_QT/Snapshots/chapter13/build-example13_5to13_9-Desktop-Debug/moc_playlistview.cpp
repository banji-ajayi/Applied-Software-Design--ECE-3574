...
#include "../example13_5to13_9/playlistview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlayListView_t, stringdata) + ofs \
...
const QMetaObject PlayListView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_PlayListView.data,
      qt_meta_data_PlayListView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PlayListView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlayListView.stringdata))
